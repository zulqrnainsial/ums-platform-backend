...
[
    'title' => 'Field Storage Validation',
    'code' => 'platform_field_storage_validation',
    'route' => '/platform/dynamic-field-storage-validation',
    'icon' => 'SafetyCertificateOutlined',
    'permission_name' => 'platform.dynamic_field_storage_validation.view',
    'module_code' => 'settings',
    'display_order' => 22,
],
                ],
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'code' => 'admission_dashboard',
                        'route' => '/admission/dashboard',
                        'icon' => 'DashboardOutlined',
                        'permission_name' => 'admission.dashboard.view',
                        'module_code' => 'admission',
                        'display_order' => 11,
                    ],
                    [
                        'title' => 'Admission Reports',
                        'code' => 'admission_reports',
                        'route' => '/admission/reports',
                        'icon' => 'FileTextOutlined',
                        'permission_name' => 'admission.reports.view',
                        'module_code' => 'admission',
                        'display_order' => 130,
                    ],
                    [
                        'title' => 'Admitted Candidates',
                        'code' => 'admission_admitted_candidates',
                        'route' => '/admission/admitted-candidates',
                        'icon' => 'UsergroupAddOutlined',
                        'permission_name' => 'admission.admitted-candidates.view',
                        'module_code' => 'admission',
                        'display_order' => 70,
                    ],
                    [
                        'title' => 'Seat Summary',
                        'code' => 'admission_seat_summary',
                        'route' => '/admission/seat-summary',
                        'icon' => 'TableOutlined',
                        'permission_name' => 'admission.seat-summary.view',
                        'module_code' => 'admission',
                        'display_order' => 71,
                    ],
                    [
